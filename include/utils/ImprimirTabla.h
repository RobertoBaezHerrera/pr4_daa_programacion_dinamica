...
class ImprimirTabla {
 public:
  ...
  void ImprimirResultados(ResultadoTSP resultado_fuerza_bruta, ResultadoTSP resultado_voraz, ResultadoTSP resultado_voraz_medio, ResultadoTSP resultado_programacion_dinamica, std::string fichero_entrada);
